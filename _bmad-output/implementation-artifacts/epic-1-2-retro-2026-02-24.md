...
**Participants:** Operator (Project Lead), Amelia (Dev), Quinn (QA), Winston (Architect), Paige (Tech Writer)
...
**What happened:** Real server hostnames and internal IP addresses appeared in story records, the deployment retrospective, and sprint status comments — all committed to a public repository.
